...
<div class="chart-contain">
	<div class="avg canvcon" v-show="type == 'AGVStyle'">
		...
		<div ref="meterRate" style="width:50%;height:100%;"></div>
	</div>
</div>
</template>
    ...
    Pierefs(idx){
      return function(idx) {
        ...
        var refs = {
          ...
          {
            text: "仪表盘",
            ref: that.$refs.meterRate
          }],
          OrderStyle: [{
            text: "任务类别",
            ref: that.$refs.OTaskName
          },
          {
            text: "任务状态",
            ref: that.$refs.OTaskStatus
          },
          {
            text: "工单号",
            ref: that.$refs.OOrderID
          }]
        }
  ...
  PieOption(Pieref,Option){
    ...
    var option = {
      ...
      series: [{
        ...
        type: 'pie',
        data: Option.series,
        center: this.type == "AGVStyle" ? ["50%", "50%"] : ["50%", "50%"],
        //左位置，上位置;以圆为中心
        radius: this.type == "AGVStyle" ? '60%': '80%',
