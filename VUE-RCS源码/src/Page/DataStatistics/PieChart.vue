   ...
   <panelborder :title="title" width="100%" height="35rem" :chartype="type" :index="index"> 
    <div class="contain"> 
     <div class="avg canvcon" v-show="type == 'AGVStyle'"> 
      ...
      <div ref="Pie" :style="AGVPieStyle"></div> 
  ...
  PieOption(Pieref,Option){
    var that = this
     ...
     legend:
      {   
        orient:'horizontal', 
        left:  this.type=="AGVStyle"||Pieref.text=='任务状态'?'25%':20,
        right: this.type=="AGVStyle"?10:5,  
        top:   '80%',   
        data:Option.legend                                       //legend    pie序列名 
        },
                                                                 //['正常时间','异常时间']   
     ...
     series: [ {
         ...
         data:Option.series,  
          ...
          //  position: 'inner',
           show : true,
           textStyle : {  fontWeight : 300 ,  fontSize : 16  },  //文字的字体大小
           formatter: '{b}-{c} ({d}%)' 
           } },
           },  ]
  }
